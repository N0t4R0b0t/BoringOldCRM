...
public interface OpportunityTypeRepository extends JpaRepository<OpportunityType, Long> {
    List<OpportunityType> findByTenantIdOrderByDisplayOrderAscNameAsc(Long tenantId);
    Optional<OpportunityType> findByTenantIdAndSlug(Long tenantId, String slug);
