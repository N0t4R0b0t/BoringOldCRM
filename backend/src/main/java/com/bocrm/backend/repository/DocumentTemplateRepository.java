...
public interface DocumentTemplateRepository extends JpaRepository<DocumentTemplate, Long>,
    ...
    Optional<DocumentTemplate> findByIdAndTenantId(Long id, Long tenantId);

    List<DocumentTemplate> findByTenantIdAndTemplateType(Long tenantId, String templateType);
}
